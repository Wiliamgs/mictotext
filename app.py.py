...
# --- CSS: CAMUFLAGEM TOTAL DA BARRA BRANCA ---
st.markdown("""
    <style>
    @import url('https://fonts.googleapis.com/css2?family=Inter:wght@400;600;700&display=swap');

    /* 1. O PULO DO GATO: FUNDO BRANCO SÓLIDO PARA CAMUFLAR A BARRA */
    html, body, [data-testid="stAppViewContainer"], [data-testid="stHeader"] {
        font-family: 'Inter', sans-serif;
        background-color: #ffffff !important; /* Branco puro para sumir com a barra do botão */
        color: #1a2a3a !important;
    }

    /* 2. REINSERINDO AS BOLAS DA CLÍNICA (Mas agora como detalhe sutil) */
    ...
    /* 3. REMOVENDO BORDAS E SOMBRAS DO COMPONENTE DE ÁUDIO */
    ...
    /* 4. ÁREA DE TEXTO E RESULTADOS (CARD COM LEVE CONTORNO) */
    .stTextArea textarea {
...
# --- CONTEÚDO ---
st.markdown('<div class="main-header" style="text-align:center; padding-top:20px;"><h1>Mic To Text</h1><p>Neurointegrando</p></div>', unsafe_allow_html=True)
...
# --- FOOTER ---
st.markdown("<br><hr><div style='text-align: center; color: #6c757d; font-family: Inter, sans-serif;'><p>🔒 Sua segurança é nossa prioridade. Nenhum arquivo é armazenado.</p><p><i>Feito com Carinho pela Equipe Administrativa da Clinica Neurointegrando.</i></p></div>", unsafe_allow_html=True)import streamlit as st
from streamlit_mic_recorder import mic_recorder
import whisper
import os
import time
